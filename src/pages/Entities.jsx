      ...
      <>
        ...
        <div className='entities'>
          ...
          <article>
            ...
            <div className='row'>
              <button type='button' className='button-previous-entity' onClick={ () => {history.push('/')} } >{'<'} Home</button>
              <button type='button' className='button-next-entity' onClick={ () => {history.push('/entities/orders')} } >Orders {'>'}</button>
            </div>
          </article>
        </div>
        <Footer />
